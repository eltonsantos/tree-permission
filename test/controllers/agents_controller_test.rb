...
class AgentsControllerTest < ActionController::TestCase
  ...
  test "should create agent" do
    assert_difference('Agent.count') do
      post :create, agent: { active: @agent.active, manager_id: @agent.manager_id, name: @agent.name }
    end
  ...
  test "should update agent" do
    patch :update, id: @agent, agent: { active: @agent.active, manager_id: @agent.manager_id, name: @agent.name }
    assert_redirected_to agent_path(assigns(:agent))
  end
